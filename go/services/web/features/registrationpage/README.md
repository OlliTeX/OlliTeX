# `registrationpage` — web feature package

The CE registration-page module (P3.4, services/web/modules/registration-page): the sign-up/confirm flow + `NewUserDoc` — the shared 42-field baseline user doc every user-creation path stores (also used by launchpad).
