# `languagetool` — web feature package

The LanguageTool proxy surface (P6.15): services/web/modules/languagetool (LanguageToolRouter/Controller + adminConfig) — the CE grammar-check proxy + admin config.
