# `dropbox` — web feature package

The Dropbox module surface (P6.10): `/user/dropbox/{connect,disconnect,oauth/callback,status}` + `/project/new/dropbox` import. Client of the Go dropboxinterface service.
