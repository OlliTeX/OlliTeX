# `trackchanges` — web feature package

The tracked-changes surface (P6.12): the thread/resolve/reopen/accept/comment routes over the rangestracker state machine (services/web/modules/track-changes, 11 routes).
