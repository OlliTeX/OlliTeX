...
class MendeleyNotConfiguredError extends Error {
  constructor(message = 'Mendeley connector is not configured on this instance') {
    super(message)
    this.name = 'MendeleyNotConfiguredError'
  }
}
...
/** Whether the user has a Mendeley account linked. */
...
export { MendeleyNotConfiguredError }
